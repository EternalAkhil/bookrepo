	...
	return (
		<div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-blue-100 to-purple-200 px-2 sm:px-0">
			...
			>
				...
				<button
					type="submit"
					className="w-full hover:cursor-pointer bg-blue-600 hover:bg-blue-700 text-white font-semibold py-2 rounded transition text-base flex items-center justify-center"
					disabled={loading}
				>
					{loading ? (
